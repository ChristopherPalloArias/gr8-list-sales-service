...
async function startService() {
  ...
  const swaggerOptions = {
    swaggerDefinition: {
      info: {
        title: 'List Sales Service API',
        version: '1.0.0',
        description: 'API for listing sales',
      },
    },
    apis: ['./src/index.js'],
  };
   ...
   * /sales:
   *   get:
   *     description: Get the list of sales
   *     responses:
   *       200:
  ...
  app.get('/', (req, res) => {
    res.send('List Sales Service Running');
  });

  app.listen(port, () => {
    console.log(`List Sales service listening at http://localhost:${port}`);
  });
}
